    ...
    <Box>
      ...
      <Box sx={{mt:"50px", mx:2}}>
        <Box sx={{display:"flex", width:"100", flexDirection:"row-reverse"}}>
          <TitleMediumBoldGray9Typography sx={{ mb: "11px" }}>소중한 추억의 기억을 담는 가구</TitleMediumBoldGray9Typography>
        </Box>
        ...
        <Box sx={{display:"flex", mt:"21px", pb:"84px"}}>
          ...
          <Box sx={{flex:1}}>
            <TitleSmallGray8Typography>프렌치 헤리티지는 가구 형태의 예술작품을 만드는데 탁월합니다.</TitleSmallGray8Typography>
            <TitleSmallGray8Typography>세부와 완벽에 대한 그들의 시선은 나머지 부분에서 눈에 띄는 것입니다.</TitleSmallGray8Typography>
          </Box>
        </Box>
      </Box>
      {/* 두번째 섹션 */}
      ...
      <Box sx={{mt:10, px:2, pb:"26px", borderBottom:"0.5px solid #868686"}}>
        ...
        <TitleLargeBoldGray9Typography sx={{ mb: 1, mt:2 }}>Brand story</TitleLargeBoldGray9Typography>
